...
def jugar():
    ...
    palabra_secreta = random.choice(["salsa","frijoles", "nopal", "mezcal", "esquites", "mole", "elotes", "chilaquiles", "maiz", "tortilla", "enfrijoladas", "tostadas", "memelas", "taco", "tamal", "pozole", "tequila", "pulque", "tepache", "atole", "tejate", "pozol"])
